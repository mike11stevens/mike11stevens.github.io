...
### [Exam DP-200: Implementing an Azure Data Solution](https://www.microsoft.com/en-us/learning/exam-DP-200.aspx){:target="_blank"}

"Exam DP-200: Implementing an Azure Data Solution" is one of the two required exams to achieve the [Microsoft Certified Azure Data Engineer Associate](https://www.microsoft.com/en-us/learning/azure-data-engineer.aspx){:target="_blank"}. This exam measures your ability to accomplish the following technical tasks: implement data storage solutions; manage and develop data processing; and monitor and optimize data solutions.
